...
import config
from NihalX import Carbon, YouTube, app
from NihalX.core.call import Nihal
from NihalX.misc import db
from NihalX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from NihalX.utils.exceptions import AssistantErr
from NihalX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from NihalX.utils.inline.playlist import close_markup
from NihalX.utils.pastebin import Nihalbin
from NihalX.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Nihal.force_stop_stream(chat_id)
