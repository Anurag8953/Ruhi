...
from NihalX.utils import (Nihalbin, get_channeplayCB,
                              seconds_to_min)
from NihalX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from NihalX.utils.decorators.language import language, languageCB
from NihalX.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/453e7e9dd8a08ec33b184.jpg",
        caption=_["queue_1"],
    )
