...
from NihalX.utils import get_readable_time
from NihalX.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from NihalX.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAx0CbqFYzQACC25jRh9fQbN1ZAbXph5yLAfgzBzqbAACqwcAAg6pMVYVer5bWv0qFR4E")
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAx0CbqFYzQACC61jRiC1CJ3PoKav6GARFjoKYHMy-QACvgYAAuinOVaT1LZyVZRMex4E")
    await message.reply_text(
