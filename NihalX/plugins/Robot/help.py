...
from NihalX.utils import help_pannel
from NihalX.utils.database import get_lang, is_commanddelete_on
from NihalX.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from NihalX.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAx0CbqFYzQACC7tjRiEm-4f5I2LfbTu3iZzSzkQIgwACzAYAAn5yMVbF_SVPTsDpKB4E")
